...
// 이력서 검색 ///////////////////////////////
Future<List<ResumePreviewServerData>> resumesearchpreviewfetchData(
    String? searchtext) async {
  var dio = Dio();
  try {
    final response = await dio.get(
        'http://ec2-3-39-21-42.ap-northeast-2.compute.amazonaws.com/amuze/resumesearch/?q=$searchtext');
